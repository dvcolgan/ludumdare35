    ...
    if (this.player1.health <= 0) {
      ...
      this.player2.sprite.animations.play('transform').onComplete.add((function(_this) {
        return function() {
          ...
          _this.player2.sprite.destroy();
          _this.finalText = _this.game.add.text(0, 0, 'HIT SPACE TO PLAY AGAIN', {
            fill: 'white',
            stroke: 'black',
            strokeThickness: 12,
            boundsAlignH: 'center',
          ...
          return _this.finalText.setTextBounds(0, SCREEN_HEIGHT - 120, SCREEN_WIDTH, 120);
        };
      })(this));
