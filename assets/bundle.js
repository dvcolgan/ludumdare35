...
Boss = (function() {
  function Boss(game, startX, startY, key) {
    ...
    this.sprite.animations.add('open', [2, 1, 1, 1, 0]);
    this.sprite.animations.add('closed', [0, 1, 2, 2, 2, 1, 2]);
    this.sprite.animations.play('open');
    this.game.physics.arcade.enable(this.sprite);
    this.sprite.body.bounce.set(1.0);
    this.sprite.update = (function(_this) {
      return function() {
        if (_this.sprite.body.velocity.y > 0 && _this.sprite.animations.currentAnim.name === 'closed') {
          return _this.sprite.animations.play('open');
        } else if (_this.sprite.body.velocity.y < 0 && _this.sprite.animations.currentAnim.name === 'open') {
          return _this.sprite.animations.play('closed');
        }
      };
    })(this);
  }
